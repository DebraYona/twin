...
const MapWithASearchBox = compose(
  ...
  lifecycle({
    componentWillMount() {
      ...
      if(this.props && this.props.latitude) {
        initialLat = parseFloat(this.props.latitude);
        initialLng = parseFloat(this.props.longitude);
        initialMarker = true;
        initialMarkerPosition = { lat: parseFloat(this.props.latitude), lng: parseFloat(this.props.longitude) };
      }
      else{
      ...
      this.setState({
        ...
        onPlacesChanged: () => {
          ...
          this.props.onChange(nextMarkers[0].position.lat(), nextMarkers[0].position.lng());
        },
      })
    },
  }),
